...
const MyArts = () => {
  ...
  if (arts.length === 0)
    return <p className="text-center text-xl mt-10">No Art Found</p>;

  return (
    <div className="w-11/12 mx-auto py-10">
      <h2 className="text-3xl font-bold mb-6 text-center">My Arts</h2>
          ...
          <tbody>
            {arts.map((art) => (
              ...
              >
                ...
                <td className="font-semibold">{art.title || art.name}</td>
                <td>{art.category}</td>
                <td>{art.location}</td>
                <td className="text-green-600 font-bold">${art.price}</td>
